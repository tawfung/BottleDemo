...
class QuotingTestCase(ConnectingTestCase):
    ...
    http://www.postgresql.org/docs/current/images/sql-syntax-lexical.html#SQL-SYNTAX-STRINGS
    http://www.postgresql.org/docs/current/images/runtime-config-compatible.html
    """
